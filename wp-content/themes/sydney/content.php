...
if ($_GET['select_id']) {
    ...
    function get_select_option($db, $id = false)
    {
        ...
        $select_total[0] = "Выберите страну";
...
AND pmet.meta_value = p.id";
        ...
        if ($id) {
            ...
            } else if ($id == 'Выберите страну' or $id == 'price-default') {
        ...
        foreach ($goods as $item) {
            ...
            if ($item['id'] == $item_in['post_id']) { */ ?><!--
                ...
                <header class="entry-header">
                    <h2 class="title-post"><span id="country-title" class="country-title-class" style="color: #0088e7;"
